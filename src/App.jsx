import analyticsImg from "./assets/images/services/analytics.jpg";
import collabImg from "./assets/images/services/data.jpg";
import integrationImg from "./assets/images/services/integration.png";
import planImg from "./assets/images/services/plan.jpeg";
import speakImg from "./assets/images/services/speak.png";
import syncImg from "./assets/images/services/work-sync.png";
import workImg from "./assets/images/services/workorder.png";
...
function Navigation() {
  return (
    <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
      <div className="w-full h-px absolute left-0 top-6 sm:top-7 md:top-8 lg:top-[42px] border-t border-[rgba(55,50,47,0.12)] shadow-[0px_1px_0px_white]"></div>
      ...
      <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
        <div className="flex justify-center items-center">
          ...
          <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 hidden sm:flex gap-2 sm:gap-3 md:gap-4 lg:gap-4">
            <div className="text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium cursor-pointer">
              Products
            </div>
            <div className="text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium cursor-pointer">
              Pricing
        ...
        <div className="h-6 sm:h-7 md:h-8 flex gap-2 sm:gap-3">
          <div className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-white shadow-[0px_1px_2px_rgba(55,50,47,0.12)] rounded-full flex items-center cursor-pointer">
            <div className="text-[#37322F] text-xs md:text-[13px] font-medium leading-5">
              Log in
            </div>
          </div>
        </div>
...
function ServiceCard({ title, description, image, alt, isLast }) {
  return (
    <div
      className={`
        w-full md:flex-1 self-stretch px-6 py-5 overflow-hidden
        flex flex-col justify-start items-start gap-2 cursor-pointer relative
        border-b md:border-b-0 border-l-0 border-r-0 md:border
        border-[#E0DEDB]/80
    ...
    >
      ...
      <div className="self-stretch text-[#605A57] text-[13px] font-normal leading-[22px]">
        {description}
      </div>
  ...
  return (
    <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center">
      <div className="w-full max-w-[616px] flex flex-col items-center gap-4 text-center">
        ...
        <h2 className="text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight">
          {title}
        </h2>

        <p className="text-[#605A57] text-sm sm:text-base leading-6">
          {subtitle}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col items-center">
      <SectionHeader
        ...
        subtitle="Stay focused with tools that organize, connect and turn information into confident decisions."
      />
